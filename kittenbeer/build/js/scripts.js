...
$(document).ready(function(){
    ...
    $("#beer-info-fear").hide();
	$("#beer-info-lusse").hide();
    $(".lable-image-fear").hide();
    $(".lable-image-lusse").hide();



// var beer = ['#beer-info-pale','#beer-info-fear','#beer-info-lusse']
...
$('#pale').click(function() {
	$("#beer-info-pale").fadeIn(700);
	$("#beer-info-fear").fadeOut(0.1);
	$("#beer-info-lusse").fadeOut(0.1);
...
$('#fear').click(function() {
	$("#beer-info-pale").fadeOut(0.1);
	$("#beer-info-fear").fadeIn(700);
	$("#beer-info-lusse").fadeOut(0.1);


});

$('#lusse').click(function() {
	$("#beer-info-pale").fadeOut(0.1);
	$("#beer-info-fear").fadeOut(0.1);
	$("#beer-info-lusse").fadeIn(700);
...
//bottle images roundabout slider.

$(window).load(function(){
$('ul').roundabout({
    responsive: true
}, function(){
    console.log('roundabout loaded');
})
...
$('#lusse').click(function() {
    ...
    // this is the action
    $('ul.img-slider').roundabout('animateToChild',2);
...
$('#pale').click(function() {
    ...
    // this is the action
    $('ul.img-slider').roundabout('animateToChild',0);
...
$('#fear').click(function() {
    ...
    // this is the action
    $('ul.img-slider').roundabout('animateToChild',1);
